...
#
# Firstly, we load the data and define the network in exactly the same way, except the network weights are loaded
...
# load the network weights
# filename = "weights-improvement-19-1.9435.hdf5"
filename = "weights-improvement-01-2.9731.hdf5" # choose better name
model.load_weights(filename)
